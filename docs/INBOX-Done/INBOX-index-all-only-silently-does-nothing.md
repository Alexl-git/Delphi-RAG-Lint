> **RETIRED to INBOX-Done/ on 2026-08-16 (session 21).** REFUTED 2026-08-16: `index --all --only DragLint-Cli --recompile` exits 0 having indexed 102 files / 13496 symbols. Only the NON-MATCHING selector case survived, and that is INBOX-index-only-nonmatching-section-is-a-silent-noop, which is now fixed.
