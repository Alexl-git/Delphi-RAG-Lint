> **RETIRED to INBOX-Done/ on 2026-08-16 (session 21).** REFUTED 2026-08-16: TMyProcType indexes as `type ... : procedure(A: Integer)` and TMyFuncType as `... of object`, both with shape. Fixture scratchpad/sweep4/uParserGaps.pas.
