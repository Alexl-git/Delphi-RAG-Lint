> **RETIRED to INBOX-Done/ on 2026-08-15.** DISCHARGED: a one-off reindex request for schema v18. The store is many schema versions past it (migrations covered by tests/autotest/run_migrate_v12.ps1 and the callresolve migration suites).
>
