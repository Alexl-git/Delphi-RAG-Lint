> **RETIRED to INBOX-Done/ on 2026-08-16 (session 21).** DISCHARGED 2026-08-16: #1 (FormsMap) fixed in c01c283 and guarded by run_formsmap_comment_scrub.ps1 (20/20). #2 (TypeAt hover) and #3 (todos verb) are both deliberate holds recorded in the note.
