...
**174 rules across 16 categories -- 119 built-in + 54 external `.scm`, 149
...
### Lint rule pack (174 rules)

Run `drag-lint rules` for the authoritative, always-current catalog (built-in +
external `.scm`). As of v1.7.0-alpha: **174 rules across 16 categories -- 119
