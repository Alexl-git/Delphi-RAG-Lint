...
**175 rules across 16 categories -- 121 built-in + 54 external `.scm`, 150
...
### Lint rule pack (175 rules)

Run `drag-lint rules` for the authoritative, always-current catalog (built-in +
external `.scm`). As of v1.7.0-alpha: **175 rules across 16 categories -- 121
built-in and 54 external `.scm`, 150 enabled by default, and 22 with an
