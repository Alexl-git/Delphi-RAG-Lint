...
**176 rules across 16 categories -- 122 built-in + 54 external `.scm`, 151
...
### Lint rule pack (176 rules)

Run `drag-lint rules` for the authoritative, always-current catalog (built-in +
external `.scm`). As of v1.7.0-alpha: **176 rules across 16 categories -- 122
built-in and 54 external `.scm`, 151 enabled by default, and 22 with an
