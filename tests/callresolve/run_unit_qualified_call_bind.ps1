<#
  ...
  WHAT THIS GUARD PINS
    ...
    check 4  NEG-*: a missing routine and a local of an UNKNOWN type spelled
             ...
             -- and NEG-WITH-UNDECIDED: the same call under a `with` whose target
             cannot be typed, which may own a member spelled like the unit
             (merge of ENG-16 with D14's with scope)
