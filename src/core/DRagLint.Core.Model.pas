...
type
  ...
  /// <para>Used by: declaration (DRagLint.Core.Model.pas), declaration (DRagLint.Doc.Facts.pas), declaration (DRagLint.Index.CallResolver.pas), DRagLint.CLI.DoSchema.ColumnSemantics (DRagLint.CLI.pas), DRagLint.Core.Model.TSymbolKindHelper.FromText (DRagLint.Core.Model.pas) (+19 more)</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TSymbolKind = (  // NOTE: DragLint.Plugin.StructureCache deliberately re-declares this; it is a design-time BPL that shells out to the CLI and uses only System.* units, so depending on Core.Model would link the whole engine into the IDE package
  ...
  TSymbolKindHelper = record helper for TSymbolKind
    ...
    /// <remarks>
    /// <!-- drag-lint:auto BEGIN -->
    /// <para>Called from: DRagLint.CLI.DoSchema.ColumnSemantics (DRagLint.CLI.pas)</para>
    /// <para>Pure</para>
    /// <seealso cref="DRagLint.Core.Model.TSymbolKindHelper.FromText"/>
    /// <!-- drag-lint:auto END -->
    /// </remarks>
    function ToText: string                                          ;
    /// <param name="AText"><!-- drag-lint:auto type -->const string</param>
    /// <returns><!-- drag-lint:auto type -->TSymbolKind</returns>
    /// <exception cref="Exception"><!-- drag-lint:auto exc -->Unknown symbol kind: "%s"</exception>
    /// <remarks>
    /// <!-- drag-lint:auto BEGIN -->
    /// <para>Called from: DRagLint.Storage.SQLite.ReadSymbolFromQuery (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.GetTypeCandidates (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.GetUnitLevelRoutines (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.ResolveAncestry (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.ResolveHelpers (DRagLint.Storage.SQLite.pas)</para>
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Core.Model.pas), DRagLint.Diagnostics.AstChecks.TAstChecker.CheckTypeAware.TypeTextIsFloat (DRagLint.Diagnostics.AstChecks.pas), DRagLint.Diagnostics.AstChecks.TAstChecker.CheckTypeAware.TypeTextIsInterface (DRagLint.Diagnostics.AstChecks.pas), DRagLint.Diagnostics.AstChecks.TAstChecker.CheckTypeAware.TypeTextIsPointer (DRagLint.Diagnostics.AstChecks.pas) (+8 more)</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TTypeCategory = (
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.ComputeDelta (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.InterfaceSymbolsOf (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.NameIsAmbiguous (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.WriteBaselineFile (DRagLint.Analysis.LintTree.pas) (+263 more)</para>
  /// <para>Used in units: DRagLint.Analysis.LintTree, DRagLint.Analysis.SurfaceAdapters, DRagLint.Analysis.SurfaceFingerprint, DRagLint.CLI, DRagLint.Context.Bundler, DRagLint.Convert.Apply, DRagLint.Convert.GlyphVacuum, DRagLint.Convert.PropTree, DRagLint.Core.DeclText, DRagLint.Core.Indexer (+34 more)</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TSymbol = record
    Id           : Int64      ;
    ...
    /// <remarks>
    /// <!-- drag-lint:auto BEGIN -->
    /// <para>Called from: DRagLint.CLI.DoQuery (DRagLint.CLI.pas), DRagLint.CLI.PrintSymbols (DRagLint.CLI.pas)</para>
    /// <para>Reads: GenericParams, Name</para>
    /// <para>Pure</para>
    /// <!-- drag-lint:auto END -->
    /// </remarks>
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), DRagLint.Core.Indexer.TIndexer.ApplyInheritedFieldFacts.FieldsOfAncestors (DRagLint.Core.Indexer.pas), DRagLint.Diagnostics.AstChecks.TAstChecker.CheckWithHiding.SurfaceOf.Harvest (DRagLint.Diagnostics.AstChecks.pas), DRagLint.Doc.Facts.TDocFactsBuilder.Build (DRagLint.Doc.Facts.pas), DRagLint.Doc.SymbolFacts.IsTestRoutine (DRagLint.Doc.SymbolFacts.pas) (+25 more)</para>
  /// <para>Used in units: DRagLint.Convert.PropTree, DRagLint.Core.Indexer, DRagLint.Core.Interfaces, DRagLint.Diagnostics.AstChecks, DRagLint.Doc.Facts, DRagLint.Doc.SymbolFacts, DRagLint.Index.CallResolver, DRagLint.Lint.ClassMetrics, DRagLint.Lint.ProjectRules, DRagLint.LSP.Completion, DRagLint.Resolver.TypeAt, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: DRagLint.Analysis.LintTree.CollectNameJoinFindings (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.CollectRoutineFindings (DRagLint.Analysis.LintTree.pas), DRagLint.CLI.DropRefsThatCannotBeCallers (DRagLint.CLI.pas), DRagLint.CLI.PrintReferences (DRagLint.CLI.pas), DRagLint.CLI.PrintReferencesWithContext (DRagLint.CLI.pas) (+61 more)</para>
  /// <para>Used in units: DRagLint.Analysis.LintTree, DRagLint.CLI, DRagLint.Context.Bundler, DRagLint.Convert.Apply, DRagLint.Convert.GlyphVacuum, DRagLint.Core.Interfaces, DRagLint.Doc.Facts, DRagLint.Index.CallResolver, DRagLint.Lint.ClassMetrics, DRagLint.Lint.ProjectRules (+10 more)</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TReference = record
    Id         : Int64  ;
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: DRagLint.CLI.BuildCallGraphJson (DRagLint.CLI.pas), DRagLint.CLI.DoCallPath (DRagLint.CLI.pas), DRagLint.CLI.DoDumpCallEdges (DRagLint.CLI.pas), DRagLint.CLI.DoFindCallees (DRagLint.CLI.pas), DRagLint.CLI.RenderCallGraphText (DRagLint.CLI.pas) (+13 more)</para>
  /// <para>Used in units: DRagLint.CLI, DRagLint.Core.Interfaces, DRagLint.Doc.Drift, DRagLint.Doc.Facts, DRagLint.Index.CallResolver, DRagLint.Report.RCallTree, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TCallEdge = record
    RefId               : Int64 ;
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Storage.SQLite.pas), DRagLint.Index.CallResolver.TCallResolver.BuildMaps (DRagLint.Index.CallResolver.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.GetUnitScopeEdges (DRagLint.Storage.SQLite.pas)</para>
  ...
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.BuildFindings (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.CollectNameJoinFindings (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.CollectUnchecked (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.LintTree.CompileDependents (DRagLint.Analysis.LintTree.pas) (+4 more)</para>
  /// <para>Used in units: DRagLint.Analysis.LintTree, DRagLint.Core.Interfaces, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), DRagLint.CLI.BuildCallGraphJson (DRagLint.CLI.pas), DRagLint.CLI.DoAmbiguousCalls (DRagLint.CLI.pas), DRagLint.CLI.RenderCallGraphText (DRagLint.CLI.pas), DRagLint.Doc.Facts.TDocFactsBuilder.Build (DRagLint.Doc.Facts.pas) (+6 more)</para>
  /// <para>Used in units: DRagLint.CLI, DRagLint.Core.Interfaces, DRagLint.Doc.Facts, DRagLint.Doc.SymbolFacts, DRagLint.Report.RCallTree, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Storage.SQLite.pas), DRagLint.Doc.SymbolFacts.ComputeWiring.AddDatasetLinks (DRagLint.Doc.SymbolFacts.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.FindOrmDatasetLinks (DRagLint.Storage.SQLite.pas)</para>
  /// <para>Used in units: DRagLint.Core.Interfaces, DRagLint.Doc.SymbolFacts, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Parser.DFM.pas), DRagLint.Core.Indexer.TIndexer.IndexFile (DRagLint.Core.Indexer.pas), DRagLint.Lint.ProjectRules.CollectDfmPropertyNotDeclared (DRagLint.Lint.ProjectRules.pas), DRagLint.Lint.ProjectRules.CollectDfmPropertyNotDeclared.AddStreamedNames (DRagLint.Lint.ProjectRules.pas) (+11 more)</para>
  /// <para>Used in units: DRagLint.Core.Indexer, DRagLint.Core.Interfaces, DRagLint.Lint.ProjectRules, DRagLint.Parser.Delphi13, DRagLint.Parser.DFM, DRagLint.Parser.Sql, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Storage.SQLite.pas), DRagLint.CLI.DoQueryText (DRagLint.CLI.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.SearchText (DRagLint.Storage.SQLite.pas)</para>
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: DRagLint.CLI.ApplyLineMarkers (DRagLint.CLI.pas), DRagLint.CLI.ApplyLineMarkers.EmitHint (DRagLint.CLI.pas), DRagLint.CLI.BuildAutofixEdits (DRagLint.CLI.pas), DRagLint.CLI.BuildExceptionRewriteEdits (DRagLint.CLI.pas), DRagLint.CLI.ScopeWalkFindingsToClosure (DRagLint.CLI.pas) (+144 more)</para>
  ...
  /// <summary><!-- drag-lint:auto sum -->v0.40.4: captured from `uses` clauses to support
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Analysis.LintTree.pas), declaration (DRagLint.Analysis.SurfaceFingerprint.pas), DRagLint.Analysis.LintTree.InterfaceUsesOf (DRagLint.Analysis.LintTree.pas), DRagLint.Analysis.SurfaceAdapters.TryFingerprintOfIndex (DRagLint.Analysis.SurfaceAdapters.pas), DRagLint.Analysis.SurfaceFingerprint.InterfaceUsesLine (DRagLint.Analysis.SurfaceFingerprint.pas) (+25 more)</para>
  /// <para>Used in units: DRagLint.Analysis.LintTree, DRagLint.Analysis.SurfaceAdapters, DRagLint.Analysis.SurfaceFingerprint, DRagLint.CLI, DRagLint.Core.Interfaces, DRagLint.Lint.ProjectChecks, DRagLint.Lint.ProjectRules, DRagLint.Parser.Delphi13, DRagLint.Refactor.EnumHelper, DRagLint.Refactor.TextEdit, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TUnitUse = record
  ...
  // an unstable diff.
  /// <summary><!-- drag-lint:auto sum -->One 'global-only' uses edge: ReaderFileId
  /// depends on DeclFileId for NOTHING but the named interface-section global
  /// variable(s), so RELOCATING them deletes the edge. Produced by
  /// ISymbolStore.FindGlobalOnlyUsesEdges; consumed by global-only-uses-edge. GlobalNames
  /// arrives comma-separated and in UNSPECIFIED order (SQLite's GROUP_CONCAT gives no
  /// ordering guarantee) -- the rule sorts before it renders, because an unstable message
  /// is an unstable diff.</summary>
  /// <remarks>
  /// <!-- drag-lint:auto -->AllInterfaceTyped is TRUE only when EVERY carrying global's declared
  /// type resolves, in this index, to a symbol of kind 'interface'. It is the sole licence to say
  /// "inject" (owner ruling 2026-08-30): an interface can be registered and resolved, a Boolean
  /// cannot. It is deliberately ALL and not ANY -- injecting the interface half of a mixed edge
  /// leaves the other global carrying it, so the edge survives and the advice would be false. One
  /// uses edge weighed by how many of the target's globals the reader actually touches -- the
  /// coupling census. Sibling of TGlobalOnlyEdge and deliberately NOT the same question: that one
  /// asks whether the edge can be DELETED, this one asks how heavy it is, and makes no only-link
  /// claim.
  ///
  /// Counts are REFERENCED names, not everything B exports. What B exports is a property of B alone
  /// -- the same number on every edge into B -- so it cannot rank edges or justify acknowledging
  /// one over another, which is the owner's stated purpose ("must go together when separated for a
  /// test").
  ///
  /// Names arrive comma-separated and UNORDERED (GROUP_CONCAT gives no ordering guarantee); the
  /// rule sorts before rendering, because an unstable message is an unstable diff.
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Storage.SQLite.pas), DRagLint.Lint.ProjectRules.CollectUsesGlobalCensus (DRagLint.Lint.ProjectRules.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.FindUsesGlobalCensus (DRagLint.Storage.SQLite.pas)</para>
  /// <para>Used in units: DRagLint.Core.Interfaces, DRagLint.Lint.ProjectRules, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <summary><!-- drag-lint:auto sum -->One DECLARING SITE of a name that is declared at
  /// interface unit level in two or more indexed units. Rows arrive one per SITE, ordered
  /// by (lower(name), lower(path), start_line), so the rule groups them in Delphi: the
  /// whole result set is 22 rows on ORM3 and grouping in SQL would buy nothing but a
  /// GROUP_CONCAT whose order is not guaranteed.</summary>
  /// <remarks>
  /// <!-- drag-lint:auto -->Signature carries the DECLARATION TEXT INCLUDING THE INITIALIZER
  /// ('Integer = 15', a whole TColor array), which is what makes the identical-vs-differing verdict
  /// a query-time read rather than a re-parse. Compare it NORMALIZED -- lowercased, whitespace runs
  /// collapsed: raw comparison calls ORM3's tbltdistrcount a difference on 'integer' versus
  /// 'Integer', and a case difference is not a semantic one.
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Storage.SQLite.pas), DRagLint.Lint.ProjectRules.CollectDuplicateGlobalDecls (DRagLint.Lint.ProjectRules.pas), DRagLint.Lint.ProjectRules.CollectDuplicateGlobalDecls.CollectLibraryMasking (DRagLint.Lint.ProjectRules.pas), DRagLint.Lint.ProjectRules.CollectDuplicateGlobalDecls.CollectLibraryMasking.ReportName (DRagLint.Lint.ProjectRules.pas) (+3 more)</para>
  /// <para>Used in units: DRagLint.Core.Interfaces, DRagLint.Lint.ProjectRules, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Storage.SQLite.pas), DRagLint.Lint.ProjectRules.CollectGlobalOnlyUsesEdges (DRagLint.Lint.ProjectRules.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.FindGlobalOnlyUsesEdges (DRagLint.Storage.SQLite.pas)</para>
  /// <para>Used in units: DRagLint.Core.Interfaces, DRagLint.Lint.ProjectRules, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <summary><!-- drag-lint:auto sum -->v0.16 Task 13: .drag-lint.json "docs" section
  ...
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.CLI.pas), declaration (DRagLint.Core.Indexer.pas), declaration (DRagLint.Core.Model.pas), DRagLint.CLI.DoSelfTestRecreate (DRagLint.CLI.pas), DRagLint.Core.Indexer.TIndexer.Create/3 (DRagLint.Core.Indexer.pas)</para>
  ...
  /// <summary>How the 'Catches:' doc fact (the exceptions a routine HANDLES,
  /// INBOX-report-exceptions-raised-and-handled gap 3) is rendered: which
  /// routines count as "showing a dialog", and how many entries the line
  /// may carry. Parsed from the manifest's docs block (docs.dialog_routines,
  /// docs.max_handles) and threaded to every renderer -- document, doc-drift,
  /// hover, LSP -- so the writer and the checker cannot disagree.</summary>
  /// <remarks>
  /// DialogRoutines is matched on the LAST dotted segment, case-insensitively,
  /// so a configured 'Application.MessageBox' and a bare 'MessageBox' both hit
  /// a call written either way. That looseness is deliberate: the fact carries
  /// the routine that matched as its witness, so a false hit is visible.
  /// An EMPTY list is the feature's off switch (no 'dialog:' disposition is
  /// ever emitted) -- the escape hatch for a project whose error dialog is a
  /// method on a singleton. A zeroed record is therefore "dialogs off, cap at
  /// the default", not "invalid"; construct with Defaults for the built-in set.
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Model.pas), declaration (DRagLint.Doc.Batch.pas), declaration (DRagLint.Doc.Document.pas), DRagLint.Doc.Document.TDocumenter.BuildFor/10 (DRagLint.Doc.Document.pas), DRagLint.Doc.Document.TDocumenter.BuildFor/2 (DRagLint.Doc.Document.pas) (+9 more)</para>
  /// <para>Used in units: DRagLint.Core.Model, DRagLint.Doc.Batch, DRagLint.Doc.Document, DRagLint.Doc.Facts, DRagLint.Index.Manifest</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TDocHandlesOptions = record
    /// <summary>Routine names whose call in a handler body makes the
    /// disposition 'dialog: name'. Empty = never.</summary>
    DialogRoutines: TArray<string>;
    /// <summary>Cap on rendered entries; overflow is a visible '(+N more)'.
    /// 0 or negative = the default (8).</summary>
    MaxHandles    : Integer;
    /// <summary>The built-in dialog set (ShowMessage, MessageDlg,
    /// Application.MessageBox, Application.HandleException) and a cap of 8.</summary>
    /// <returns>A fully populated record.</returns>
    /// <remarks>
    /// <!-- drag-lint:auto BEGIN -->
    /// <para>Called from: DRagLint.Doc.Document.TDocumenter.BuildFor/2 (DRagLint.Doc.Document.pas), DRagLint.Doc.Facts.TDocFactsRenderOptions.Defaults (DRagLint.Doc.Facts.pas), DRagLint.Index.Manifest.LoadDocHandlesOptions (DRagLint.Index.Manifest.pas), DRagLint.Index.Manifest.TDocSettings.Defaults (DRagLint.Index.Manifest.pas)</para>
    /// <para>Pure</para>
    /// <para>Directives: static</para>
    /// <!-- drag-lint:auto END -->
    /// </remarks>
    class function Defaults: TDocHandlesOptions; static;
  end;

const
  /// <summary>Default cap on 'Catches:' entries; see TDocHandlesOptions.MaxHandles.</summary>
  DOC_HANDLES_DEFAULT_CAP = 8;
...
type
  ...
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: DRagLint.CLI.CollectWikiTopics (DRagLint.CLI.pas), DRagLint.CLI.DoWiki (DRagLint.CLI.pas), DRagLint.Context.Bundler.TContextBundler.Build.MatchWikiTopics (DRagLint.Context.Bundler.pas), DRagLint.Context.Bundler.TContextBundler.RenderMarkdown (DRagLint.Context.Bundler.pas), DRagLint.Hover.Renderer.WikiIndicatorLines (DRagLint.Hover.Renderer.pas) (+8 more)</para>
  ...
  /// <remarks>
  /// Declared HERE rather than in DRagLint.Doc.Wiki so that
  ...
  /// DRAGLINT_EXTRACTOR_VERSION nor SCHEMA_VERSION moves for it.
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Storage.SQLite.pas), DRagLint.CLI.CollectWikiTopics (DRagLint.CLI.pas), DRagLint.Context.Bundler.TContextBundler.Build.MatchWikiTopics (DRagLint.Context.Bundler.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.FindWikiDocBlocks (DRagLint.Storage.SQLite.pas)</para>
  /// <para>Used in units: DRagLint.CLI, DRagLint.Context.Bundler, DRagLint.Core.Interfaces, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TWikiDocRow = record
    SymbolId : Int64  ;
  ...
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Interfaces.pas), declaration (DRagLint.Storage.SQLite.pas), DRagLint.Index.Freshness.ProbeIndexFreshness (DRagLint.Index.Freshness.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.GetAllFileStamps (DRagLint.Storage.SQLite.pas)</para>
  /// <para>Used in units: DRagLint.Core.Interfaces, DRagLint.Index.Freshness, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  TFileStamp = record
  ...
  /// <summary><!-- drag-lint:auto sum -->v0.18: resolved caller entry for a context
  /// bundle (FilePath pre-resolved from FileId so renderers don't need a store callback).</summary>
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: declaration (DRagLint.Core.Model.pas), DRagLint.Context.Bundler.TContextBundler.Build (DRagLint.Context.Bundler.pas), DRagLint.Context.Bundler.TContextBundler.RenderMarkdown (DRagLint.Context.Bundler.pas)</para>
  ...
  /// <summary><!-- drag-lint:auto sum -->v0.26: compiler diagnostic finding (from dcc64
  /// or msbuild output).</summary>
  /// <remarks>
  /// <!-- drag-lint:auto BEGIN -->
  /// <para>Used by: DRagLint.Analysis.LintTree.CompileDependents (DRagLint.Analysis.LintTree.pas), DRagLint.CLI.DoCompileCheck (DRagLint.CLI.pas), DRagLint.CLI.DoLintTree (DRagLint.CLI.pas), DRagLint.CLI.NormalizeFindings (DRagLint.CLI.pas), DRagLint.CLI.RefreshProjectFindingsCore (DRagLint.CLI.pas) (+15 more)</para>
  /// <para>Used in units: DRagLint.Analysis.LintTree, DRagLint.CLI, DRagLint.Core.Interfaces, DRagLint.Diagnostics.CompileCheck, DRagLint.LSP.Completion, DRagLint.MCP.Server, DRagLint.Storage.SQLite</para>
  /// <!-- drag-lint:auto END -->
  /// </remarks>
  ...
  /// <summary><!-- drag-lint:auto sum -->v0.18: context bundle -- minimum AI-ready slice
...
/// <remarks>
/// <!-- drag-lint:auto BEGIN -->
/// <para>Called from: DRagLint.CLI.DoQueryUnitUsageProjectWide (DRagLint.CLI.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.UpsertUnitUse (DRagLint.Storage.SQLite.pas)</para>
/// <para>Pure</para>
/// <!-- drag-lint:auto END -->
/// </remarks>
...
/// closing.
/// <!-- drag-lint:auto BEGIN -->
/// <para>Called from: DRagLint.Core.Model.IsCompilerIntrinsic (DRagLint.Core.Model.pas), DRagLint.Diagnostics.FlowChecks.TFlowChecker.Check (DRagLint.Diagnostics.FlowChecks.pas), DRagLint.LSP.Server.TLSPServer.ComputeHover (DRagLint.LSP.Server.pas)</para>
/// <para>Calls: SameText</para>
...
/// <param name="AText"><!-- drag-lint:auto type -->const string</param>
/// <param name="ABare"><!-- drag-lint:auto type -->out string</param>
/// <param name="AParams"><!-- drag-lint:auto type -->out string</param>
/// <returns>True when AText carried a parameter list; False (ABare=Trim(AText),
/// AParams='') otherwise.</returns>
/// <remarks>
/// <!-- drag-lint:auto BEGIN -->
/// <para>Called from: DRagLint.Core.Model.StripGenericSegments.FlushSegment (DRagLint.Core.Model.pas), DRagLint.Parser.Delphi13.TryWalkClassOrRecord (DRagLint.Parser.Delphi13.pas), DRagLint.Parser.Delphi13.TryWalkInterface (DRagLint.Parser.Delphi13.pas), DRagLint.Parser.Delphi13.TryWalkOtherTypeDecl (DRagLint.Parser.Delphi13.pas), DRagLint.Parser.Delphi13.TryWalkProcType (DRagLint.Parser.Delphi13.pas) (+4 more)</para>
/// <para>Calls: Copy, Pos, Trim</para>
/// <para>Returns: False; True</para>
/// <para>Mutates: ABare (out), AParams (out)</para>
/// <!-- drag-lint:auto END -->
/// </remarks>
...
/// depth.</summary>
/// <param name="AParamsOrArgs"><!-- drag-lint:auto type -->const string</param>
/// <returns><!-- drag-lint:auto -->Integer -- Observed: 0.</returns>
/// <remarks>
/// <!-- drag-lint:auto BEGIN -->
/// <para>Called from: DRagLint.Storage.SQLite.FilterCandidatesByArity (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.PreferArity (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.GetTransitiveAncestors (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.ResolveAncestry (DRagLint.Storage.SQLite.pas)</para>
/// <para>Calls: Copy, DRagLint.Core.Model.GenericArity.CloseGroup, Trim</para>
/// <para>Complexity: 11 (cyclomatic, outer body), 31 lines (full implementation)</para>
/// <para>Pure</para>
/// <seealso cref="DRagLint.Core.Model.GenericArity.CloseGroup"/>
/// <!-- drag-lint:auto END -->
/// </remarks>
...
/// <returns><!-- drag-lint:auto -->string -- Observed: Copy(AName, Start, MaxInt).</returns>
/// <remarks>
/// <!-- drag-lint:auto BEGIN -->
/// <para>Called from: DRagLint.Parser.Delphi13.WalkDeclProc (DRagLint.Parser.Delphi13.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.FindSymbolsByExactName (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.FindSymbolsByQualifiedName (DRagLint.Storage.SQLite.pas)</para>
...
/// <remarks>
/// <!-- drag-lint:auto BEGIN -->
/// <para>Called from: DRagLint.Context.Bundler.ResolveUniqueName (DRagLint.Context.Bundler.pas), DRagLint.Parser.Delphi13.Walk (DRagLint.Parser.Delphi13.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.FindSymbolsByExactName (DRagLint.Storage.SQLite.pas), DRagLint.Storage.SQLite.TSQLiteSymbolStore.FindSymbolsByQualifiedName (DRagLint.Storage.SQLite.pas)</para>
/// <para>Calls: Copy, DRagLint.Core.Model.StripGenericSegments.FlushSegment, SplitGenericName</para>
/// <para>Pure</para>
/// <seealso cref="DRagLint.Core.Model.StripGenericSegments.FlushSegment"/>
/// <!-- drag-lint:auto END -->
/// </remarks>
...
class function TDocHandlesOptions.Defaults: TDocHandlesOptions;
begin
  { The four VCL shapes a Delphi handler shows an error with. A project whose
    dialog is its own routine lists it in docs.dialog_routines instead; this
    set is what an ABSENT key means, and an explicit [] means none. }
  Result.DialogRoutines:= ['ShowMessage', 'MessageDlg', 'Application.MessageBox',
                           'Application.HandleException'];
  Result.MaxHandles    := DOC_HANDLES_DEFAULT_CAP;
end;
