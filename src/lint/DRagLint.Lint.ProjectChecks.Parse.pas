...
/// <remarks>
/// <!-- drag-lint:auto BEGIN -->
/// Called from: DRagLint.Doc.Facts.ReadDeclLine (DRagLint.Doc.Facts.pas), DRagLint.Index.Closure.TClosureResolver.ParseDprUses (DRagLint.Index.Closure.pas), DRagLint.Lint.ProjectChecks.Parse.ParseUsesFromContent (DRagLint.Lint.ProjectChecks.Parse.pas)
